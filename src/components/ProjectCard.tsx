      ...
      <div className="w-full h-full face face1 p-5">
        <div className="content">
          <div className="h-20 flex justify-around items-center">
            {/* <a className="text-center text-primary/60 hover:text-primary">
                        Visualizar Projeto
                      </a> */}
            <a className="text-center text-xl text-primary hover:text-primary/60">
              Visualizar Projeto
            </a>
            <SocialIcon
              network="github"
          ...
          <p className="text-white text-xl max-h-80 scrollbar">{project.description}</p>
        </div>
      </div>
